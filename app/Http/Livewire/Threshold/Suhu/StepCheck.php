...
class StepCheck extends Component
{
    ...
    public function changeStasiun($id_stasiun)
    {
        ...
        if ($data) {
            $this->batasBawah = $data->sc_batasbawah_suspect_suhu;
            $this->batasAtas = $data->sc_batasatas_suspect_suhu;
        } else {
    ...
    public function simpan()
    {
        try {
            Threshold::updateOrCreate(
                ...
                [
                    'sc_batasatas_suspect_suhu' => $this->batasAtas,
                    'sc_batasbawah_suspect_suhu' => $this->batasBawah
                ]
            );
    ...
    {
        return view('livewire.threshold.suhu.step-check');
    }
}
